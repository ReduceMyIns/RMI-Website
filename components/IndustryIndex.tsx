...
import { Search, ArrowRight, Shield, Globe, FilterX, Sparkles } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-6 py-16 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <div className="text-center max-w-3xl mx-auto space-y-8 mb-16">
        ...
        <p className="text-slate-400 text-lg">
          Browse our autonomous risk database covering professions across the major SIC groups. Find your specific niche for tailored AI underwriting.
        </p>
        ...
        <div className="relative max-w-xl mx-auto group">
          ...
          <input 
            type="text" 
            placeholder="Search by profession, trade, or keyword..." 
            value={filter}
