...
const CommercialLinesPage: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-32">
      <SEOHead 
        title="Commercial Business Insurance | Protect Your Operations"
        description="Comprehensive business insurance solutions in Murfreesboro, TN. General Liability, Workers' Comp, and Commercial Auto from top carriers."
        canonicalUrl="https://www.reducemyinsurance.net/commercial"
        keywords={['business insurance', 'commercial insurance', 'general liability', 'workers comp', 'commercial auto', 'Murfreesboro business']}
      />
