...
const WatercraftPage: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <SEOHead 
        title="Boat & Watercraft Insurance | Marine Quotes"
        description="Comprehensive boat and yacht insurance for Murfreesboro watercraft owners. Coverage for physical damage, liability, and wreck removal."
        canonicalUrl="https://www.reducemyinsurance.net/watercraft"
        keywords={['boat insurance', 'watercraft insurance', 'yacht insurance', 'marine insurance', 'Murfreesboro TN']}
      />
